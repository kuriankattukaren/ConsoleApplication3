...
namespace UnitTestDates
{
	...
	public:
		...
		TEST_METHOD(TestAssignmentOperator) {
			auto date_of_birth = dates::date(int{ 13 }, dates::month::June, int{ 1979 });
		...
		TEST_METHOD(TestChangeDates) {
			auto new_date = dates::date(int{ 23 }, dates::month::July, int{ 1979 });
			auto current_date = dates::date(int{ 22 }, dates::month::September, int{ 2018 })
